...
export const UNIFIED_TOOL_REGISTRY = {
  ...
  salesforce: {
    ...
    mcp_functions: [
      ...
      { name: 'sf_create_note', description: 'Add a note to any Salesforce record (Contact, Lead, Account, Opportunity, etc.). Use parent_id for the record ID. CRITICAL: Always search for the contact/lead FIRST to get their ID, then use that ID as parent_id. IMPORTANT: Set use_classic_notes=true to create Classic Notes that appear in "Notes & Attachments" (required for compatibility). Classic Notes will show in both "Notes & Attachments" AND the Activity timeline.', params: ['parent_id', 'title', 'body', 'use_classic_notes'] },
